...
<div class="page">
       <div class="navbar">
           <img src="Images/ss_logo.png" class="logo">
           <h1>Urban<span style="font-family: 'Merienda', cursive;
            color:rgb(20, 76, 80);">Sphere</span></h1>
           <nav>
               <ul>
	    ...
	    <div>
          	<button onclick="redirectToPage('login.html')" class="but">Residents </button>
          	<button onclick="redirectToPage('Adminlogin.php')" class="but">Admin</button>
       ...
       <div class="row">
        ...
        <div class="col-2">
           <div class="form-container1">
               <div class="adminfbtn">
                   <h1>Community member Login</h1>
               </div>
               <img src="Images/cmlogo.jpg" class="admimg" alt="">
               <form action="cmlogin.php" method="POST">
                    <input type="text" placeholder="Username" name="username" required>
                    <input type="text" placeholder="Password" name="Cmcode" required>
                    <button type="submit" class="btn-losi" name="logincm" >Login</button>     
                </form>
            </div>
        </div>
        </div>
    ...
    <footer>
        <div class="main-content">
            <div class="left box">
                ...
                <div class="content">
                    <p>
                        UrbanSphere is webapp  where society members can get all the updates related to their society. The members also get notified with notices and events held in society and can see information about members in society. Members can also post complaints regarding any issue in society. 
                    </p>
                </div>
            </div>
            ...
            <div class="right box">
                ...
                <div class="content">
                    <div class="place">
                        ...
                        <span class="text">T.V Chidambaram, Sion(East)</span>
                    </div>
                    <div class="phone">
                        <span class="fas fa-phone-alt"></span>
                        <span class="text">+91 9769418371</span>
                    </div>
                    <div class="email">
                        <span class="fas fa-envelope"></span>
                        <span class="text">UrbanSphere@gmail.com</span>
                    </div>
                </div>
            </div>
        </div>
...
<!-- Php code to Cm login -->
<?php
// Define community member username and code pairs
$validUsers = [
    "CM" => "100",
    "CM1" => "200",
    "CM2" => "300",  // Add more community members and codes as needed
    "CM3" => "400",
];

if (isset($_POST['logincm'])) {
    // Get the entered username and code
    $user = $_POST['username'];
    $cmcode = $_POST['Cmcode']; 

    // Validate if community member exists in the array and the code matches
    if (isset($validUsers[$user]) && $validUsers[$user] == $cmcode) {
        echo "<script>alert('Welcome, You are logged in...!');
        window.location.href = 'managecm.php'; // Redirect to member management page
        </script>";
    } else {
