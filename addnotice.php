...
<input type="checkbox" id="check">
    ...
    <div class="sidebar">
      <center>
       ...
       <a href="managemem.php"class="active"><i class="fas fa-desktop"></i><span>Manage Residents</span></a>
  ...
  <!--    <a href="viewcomplaints.php" ><i class="fas fa-envelope-open-text"></i><span>View Complaints</span></a> -->
     <a href="admin_payment.php" ><i class="fas fa-file-invoice-dollar"></i><span>View Payments</span></a> 
    ...
    <div class="container">
        ...
        <form action="#" method="POST">
          <input type="text" class="field" name="nname" placeholder="Meet Name" required>
          <input type="time" class="field" name="ntime" placeholder="Meeting Time" required>
          <input type="date" class="field" name="ndate" placeholder="Meeting Date" required>
...
if(isset($_POST['send_notice'])){
  ...
  $query = "insert into notices values(null,'$_POST[nname]','$_POST[ntime]','$_POST[ndate]','$_POST[nmsg]')";
  $query_run = mysqli_query($connection,$query);
  if($query_run){
    echo "<script>alert('Meeting Updated...!!');
